  ...
  React.createElement(
    ...
    >
      ...
      <g fill="none">
        ...
        <g fill="#FFF">
          <path d="M16 4a10.919 10.919 0 100 21.838c6.03 0 10.919-4.889 10.919-10.92C26.919 8.889 22.03 4 16 4m0 21.396c-5.791 0-10.486-4.695-10.486-10.486S10.209 4.424 16 4.424 26.486 9.119 26.486 14.91 21.791 25.396 16 25.396" />
