    ...
    >
      ...
      <g fill="none">
        ...
        <g fill="#FFF">
          <path
            opacity={0.6}
            d="M20.006 14.916l-3.975 3.975h7.949l-3.974-3.975z"
          />
          <path opacity={0.7} d="M12.025 14.92L16 10.945H8.05l3.976 3.975z" />
          <path
            opacity={0.4}
            d="M16.03 18.891l3.966-3.965-3.983-3.983-7.95 7.949 7.95 7.949 7.948-7.949z"
          />
          <path
            opacity={0.8}
            d="M16.05 3l-7.945 7.944H16l-3.952 3.952 4.001 4.001 7.949-7.948z"
          />
        </g>
      </g>
    </svg>
