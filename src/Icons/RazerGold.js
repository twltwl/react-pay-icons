  ...
  React.createElement(
    ...
    <svg width={60} height={40} xmlns="http://www.w3.org/2000/svg" {...props}>
      <defs>
        ...
        >
          <stop stopColor="#D17600" stopOpacity={0.948} offset="0%" />
          <stop stopColor="#D67600" stopOpacity={0.703} offset="52.82%" />
        ...
        >
          <stop stopColor="#FA0" stopOpacity={0} offset="0%" />
          <stop stopColor="#9C6322" stopOpacity={0} offset="100%" />
        </radialGradient>
        <linearGradient
          x1="49.735%"
        ...
        >
          ...
          <stop stopColor="#874E0A" stopOpacity={0.632} offset="26.43%" />
        ...
        >
          <stop stopColor="#FFFBC9" offset="7.692%" />
        ...
        >
          ...
          <stop stopColor="#C45A03" stopOpacity={0.262} offset="81.03%" />
        ...
        >
          ...
          <stop stopColor="#F8F8F8" stopOpacity={0.833} offset="48.21%" />
          <stop stopColor="#F7F1E3" offset="52.31%" />
          <stop stopColor="#F8E9AE" stopOpacity={0.885} offset="61.54%" />
          <stop stopColor="#F9DD5F" stopOpacity={0.802} offset="66.15%" />
          <stop stopColor="#FBE262" stopOpacity={0.661} offset="72.31%" />
          <stop stopColor="#F8E6AB" stopOpacity={0.088} offset="80.51%" />
        ...
        >
          <stop stopColor="#F8DD88" offset="4.615%" />
          <stop stopColor="#F7F6F3" stopOpacity={0.031} offset="59.49%" />
        </linearGradient>
        <linearGradient
          x1="50.123%"
          y1="100.123%"
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g fillRule="nonzero">
          ...
          />
          <g fill="#B86A09">
            <path d="M29.1 17.93h-2.34l-.9 1.62h8.82l.9-1.62h-2.52l3.51-6.03H24.96l-1.89 3.15h7.56l-1.53 2.88ZM30.63 22.07h2.52l.9-1.62h-8.91l-.9 1.62h2.34l-3.42 6.03h11.61l1.89-3.15H29.1l1.53-2.88Z" />
          </g>
          <path
          ...
          <g transform="translate(12 2)">
            <circle fill="url(#razer_gold_svg__d)" cx={18} cy={18} r={18} />
            <circle
              cx={18}
              cy={18}
              r={18}
            ...
            />
            <circle fill="url(#razer_gold_svg__f)" cx={18} cy={18} r={18} />
            <path
              d="M.27 21.06C1.71 29.52 9.09 36 18 36s16.29-6.48 17.73-14.94H.27Z"
              fill="url(#razer_gold_svg__g)"
            />
            <circle fill="#F7C63B" cx={18} cy={18} r={14.4} />
            <circle fill="url(#razer_gold_svg__h)" cx={18} cy={18} r={18} />
            <circle
