    ...
    >
      ...
      <defs>
        <linearGradient
          ...
          id="linearGradient-1"
        >
          <stop stopColor="#965609" stopOpacity={0.5} offset="0%" />
          <stop stopColor="#874E0A" stopOpacity={0.6322} offset="26.43%" />
          <stop stopColor="#5E370B" offset="100%" />
        </linearGradient>
        <radialGradient
          cx="52.4226667%"
          cy="-6.85529412%"
          ...
          id="radialGradient-2"
        >
          <stop stopColor="#FFAA00" offset="0%" />
          <stop stopColor="#9C6322" stopOpacity={0} offset="100%" />
        </radialGradient>
        <radialGradient
          cx="49.7346667%"
          cy="-29.6988235%"
        ...
        <linearGradient
          ...
          id="linearGradient-4"
        >
          <stop stopColor="#FFFBC9" offset="7.692307%" />
          <stop stopColor="#FFD22E" offset="17.44%" />
          <stop stopColor="#EB920C" offset="100%" />
        </linearGradient>
        <linearGradient
          x1="50.0005%"
          y1="2.7615%"
          ...
          id="linearGradient-5"
        >
          <stop stopColor="#FFC421" offset="0%" />
          <stop stopColor="#E38900" offset="100%" />
        </linearGradient>
        <radialGradient
          cx="50.0005%"
          cy="97.68325%"
          ...
          id="radialGradient-6"
        >
          <stop stopColor="#D17600" stopOpacity={0.9481} offset="0%" />
          <stop stopColor="#D67600" stopOpacity={0.7026} offset="52.82%" />
          <stop stopColor="#E28D0C" stopOpacity={0} offset="100%" />
        </radialGradient>
        <linearGradient
          x1="16.2860406%"
          y1="-21.2807229%"
          ...
          id="linearGradient-7"
        >
          <stop stopColor="#FFD900" stopOpacity={0} offset="43.08%" />
          <stop stopColor="#D67D00" offset="62.05%" />
          <stop stopColor="#C45A03" stopOpacity={0.2615} offset="81.03%" />
          <stop stopColor="#FFBD08" stopOpacity={0} offset="100%" />
        </linearGradient>
        <linearGradient
          x1="16.05475%"
          y1="30.40175%"
          ...
          id="linearGradient-8"
        >
          <stop stopColor="#FFF06E" stopOpacity={0} offset="18.97%" />
          <stop stopColor="#FDFBF5" stopOpacity={0.4} offset="31.79%" />
          <stop stopColor="#F8F8F8" stopOpacity={0.8327} offset="48.21%" />
          <stop stopColor="#F7F1E3" offset="52.31%" />
          <stop stopColor="#F8E9AE" stopOpacity={0.8853} offset="61.54%" />
          <stop stopColor="#F9DD5F" stopOpacity={0.8021} offset="66.15%" />
          <stop stopColor="#FBE262" stopOpacity={0.6615} offset="72.31%" />
          <stop stopColor="#F8E6AB" stopOpacity={0.08820513} offset="80.51%" />
          <stop stopColor="#F7E5BC" stopOpacity={0} offset="93.85%" />
        </linearGradient>
        <radialGradient
          cx="49.875625%"
          cy="50.125%"
          ...
          id="radialGradient-9"
        >
          <stop stopColor="#F8DA7A" stopOpacity={0} offset="0%" />
          <stop stopColor="#F7CC1B" offset="91.28%" />
          <stop stopColor="#F7790A" stopOpacity={0.3} offset="100%" />
        </radialGradient>
        <radialGradient
          cx="49.8122754%"
          cy="24.1718563%"
        ...
        >
          <stop stopColor="#FFFAEB" offset="0%" />
          <stop stopColor="#C9C595" stopOpacity={0} offset="47.18%" />
        </radialGradient>
        <radialGradient
          cx="6.03847885%"
          cy="1.80678438%"
        ...
        >
          <stop stopColor="#F8DD88" stopOpacity={0.3} offset="58.46%" />
          <stop stopColor="#F7962F" stopOpacity={0} offset="100%" />
        </radialGradient>
        <radialGradient
          cx="49.7043798%"
          cy="25.8112054%"
        ...
        >
          <stop stopColor="#ED7A00" offset="0%" />
          <stop stopColor="#F1C130" stopOpacity={0.6} offset="99.49%" />
        </linearGradient>
        <linearGradient
          x1="50.1203593%"
          y1="99.8802395%"
        ...
        >
          <stop stopColor="#F8DD88" offset="4.615385%" />
          <stop stopColor="#F7F6F3" stopOpacity={0.03076923} offset="59.49%" />
        </linearGradient>
        <linearGradient
          x1="50.1233129%"
          y1="100.123077%"
        ...
        >
          <stop stopColor="#693619" offset="0%" />
          <stop stopColor="#A3620C" offset="100%" />
        </linearGradient>
        <radialGradient
          cx="51.9173333%"
          cy="1.906408%"
        ...
        >
          <stop stopColor="#784507" stopOpacity={0.5} offset="0%" />
          <stop stopColor="#874E0A" stopOpacity={0.6322} offset="26.43%" />
          <stop stopColor="#5C360B" offset="100%" />
        </linearGradient>
        <radialGradient
          cx="50.4013333%"
          cy="49.9744444%"
        ...
        >
          <stop stopColor="#FFAA00" stopOpacity={0} offset="0%" />
          <stop stopColor="#9C6322" stopOpacity={0} offset="100%" />
        </radialGradient>
      </defs>
      <g
        ...
        fillRule="evenodd"
      >
        <rect fill="#000000" x={0} y={0} width={60} height={40} />
        <g transform="translate(12.000000, 2.000000)" fillRule="nonzero">
          <path
          ...
          <g id="Group" transform="translate(10.800000, 9.900000)">
            <path
              d="M6.3,6.03 C4.95,6.03 3.96,6.03 3.96,6.03 L3.06,7.65 L5.4,7.65 L9.36,7.65 L11.88,7.65 L12.78,6.03 C12.78,6.03 11.7,6.03 10.26,6.03 L13.77,0 C13.77,0 2.16,0 2.16,0 L0.27,3.15 L7.83,3.15 L6.3,6.03 Z"
              id="Shape"
          ...
          <g id="Group">
            <g>
              ...
              />
              <circle id="Oval" fill="#F7C63B" cx={18} cy={18} r={14.4} />
              <circle
                id="Oval"
              ...
              <circle
                ...
                r={14.4}
              />
              <g transform="translate(1.800000, 1.800000)" id="Shape">
                <path
            ...
            <g transform="translate(10.800000, 9.900000)" id="Shape">
              <path
                d="M7.83,10.17 L10.35,10.17 L11.25,8.55 C11.25,8.55 10.17,8.55 8.73,8.55 L4.5,8.55 C3.24,8.55 2.34,8.55 2.34,8.55 L1.44,10.17 L3.78,10.17 L0.36,16.2 C0.36,16.2 11.97,16.2 11.97,16.2 L13.86,13.05 L6.3,13.05 L7.83,10.17 Z"
            ...
            <g
              ...
              id="Shape"
            >
              <path d="M6.3,6.03 C4.95,6.03 3.96,6.03 3.96,6.03 L3.06,7.65 L5.4,7.65 L9.36,7.65 L11.88,7.65 L12.78,6.03 C12.78,6.03 11.7,6.03 10.26,6.03 L13.77,0 C13.77,0 2.16,0 2.16,0 L0.27,3.15 L7.83,3.15 L6.3,6.03 Z" />
              <path d="M7.83,10.17 L10.35,10.17 L11.25,8.55 C11.25,8.55 10.17,8.55 8.73,8.55 L4.5,8.55 C3.24,8.55 2.34,8.55 2.34,8.55 L1.44,10.17 L3.78,10.17 L0.36,16.2 C0.36,16.2 11.97,16.2 11.97,16.2 L13.86,13.05 L6.3,13.05 L7.83,10.17 Z" />
            </g>
            <path
