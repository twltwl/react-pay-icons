...
export function getFlagSvgUrl(key, transparent = false) {
	...
	const FLAGS_SVGS_URLS = {
		...
		direct_debit: `${ICONS_PATH}${transparentStr}/Direct_debit.js`,
		...
		skrill_moneybookers: `${ICONS_PATH}${transparentStr}/Skrill_moneybookers.js`,
		...
		visa_electron: `${ICONS_PATH}${transparentStr}/Visa_electron.js`,
