      ...
      <g transform="translate(-52.013 -433.49)" id="layer1">
        ...
        >
          <g id="Camada_x0020_1">
            ...
            />
            <path
              d="m132.905 152.927-.193-43.487h-8.466l.096 43.968c-.026 8.15 8.397 9.259 12.508 11.16l3.367-8.37-7.312-3.271z"
              id="path3005"
              fill="none"
            />
            <path
            ...
            />
            <path
              d="m60.94 135.609.192 28.093h8.563l.096-28.093c.29-8.16-8.098-9.86-12.604-11.641l-3.656 8.37 7.409 3.271z"
              id="path3015"
              fill="#000"
            />
            <path
            ...
            />
            <path
              d="m124.246 109.44.096 43.968c-.026 8.15 8.397 9.259 12.507 11.16l3.368-8.37-7.312-3.271-.193-43.487h-8.466z"
              id="path3021"
              fill="#000"
            />
            <path
