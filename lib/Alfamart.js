...
(function (global, factory) {
  ...
  var SvgAlfamart = function SvgAlfamart(props) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      d: "M10.8 17.8H9.4c.2-.6.4-1.1.7-1.6h.1s.1 0 .1.1c.2.4.4.9.5 1.5m3.5 2-2.5-5c-.4-.5-1-.8-1.6-.7-.7-.1-1.4.2-1.9.8l-1.9 3.7c-.3.5-1.3 1.9.6 1.9 1.8.1 1.6-1.6 1.9-1.6h2.4c.2.6.2 1.5 1.8 1.6.9.1 1.4-.4 1.2-.7M26.6 19.2c-.1.1-.2.1-.4.1-.7 0-.9-.3-.9-.7-.1-.4-.1-.9 0-1.3.1-.3.4-.6.8-.6.4-.1.8.2.9.6.1.4.2 1.6-.4 1.9m2.5-3.3c0-.4-1.5-.4-1.9-.2l-.2.1c-.2 0-.5-.1-.8-.2-.6-.1-1.2-.1-1.8.1-1.8.7-2.4 4.1.4 4.5.7.1 1.5 0 2.2-.2.1 0 .1 0 .1.1.1.1.1.1.2.1.3.1.7.1 1 .1.5 0 .9-.3.9-.5-.1-1.2 0-2.5-.1-3.9",
      fill: "#243F8F"
    }), /*#__PURE__*/React.createElement("path", {
