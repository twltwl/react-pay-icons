  ...
  React.createElement(
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" {...props}>
      <g fill="none">
        ...
        <g fill="#FFF">
          <path d="M16 4a11.911 11.911 0 1 0 0 23.823c6.579 0 11.911-5.333 11.911-11.912C27.911 9.333 22.58 4 16 4m0 23.341c-6.318 0-11.44-5.122-11.44-11.44C4.56 9.585 9.683 4.463 16 4.463s11.44 5.122 11.44 11.44S22.318 27.342 16 27.342" />
