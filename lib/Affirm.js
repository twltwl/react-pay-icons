  ...
  React.createElement(
    ...
    >
      <mask
        ...
        height={22}
      >
        <path d="M0 26.97h18.34v20.912H0V26.97Z" fill="#fff" />
      </mask>
      <g mask="url(#mask0)">
        <path
          fillRule="evenodd"
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M62.834 27.55v19.752h5.65v-9.516c0-4.525 2.737-5.852 4.647-5.852.745 0 1.75.215 2.415.713l1.03-5.222c-.873-.373-1.785-.455-2.533-.455-2.905 0-4.73 1.287-5.934 3.9v-3.32h-5.275Z"
        fill="#060809"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M102.766 26.97c-2.988 0-5.22 1.767-6.382 3.47-1.08-2.2-3.368-3.47-6.105-3.47-2.987 0-5.054 1.66-6.01 3.568V27.55h-5.445v19.752h5.653V37.135c0-3.652 1.91-5.4 3.695-5.4 1.615 0 3.1 1.045 3.1 3.74v11.827h5.644V37.135c0-3.692 1.868-5.4 3.735-5.4 1.492 0 3.067 1.085 3.067 3.7v11.867h5.645V33.65c0-4.44-2.987-6.68-6.597-6.68Z"
        fill="#060809"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M49.082 27.55h-5.118v-2.01c0-2.612 1.492-3.36 2.78-3.36 1.42 0 2.527.631 2.527.631l1.742-3.982s-1.766-1.155-4.977-1.155c-3.61 0-7.717 2.035-7.717 8.422v1.453H29.75V25.54c0-2.612 1.493-3.36 2.778-3.36.731 0 1.716.17 2.53.631L36.8 18.83c-1.04-.612-2.71-1.155-4.977-1.155-3.61 0-7.717 2.035-7.717 8.422v1.453h-3.278v4.357h3.278v15.394h5.644V31.907h8.569v15.394h5.645V31.907h5.118V27.55Z"
        fill="#060809"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M52.452 47.302h5.64V27.551h-5.64v19.751Z"
        fill="#060809"
      />
      <path
        fillRule="evenodd"
