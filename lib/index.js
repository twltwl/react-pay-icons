(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "./Amazon", "./AmazonTransparent", "./Amex", "./Applepay", "./Aura", "./Bb", "./BbTransparent", "./Bitcoin", "./Boleto", "./BoletoTransparent", "./Bradesco", "./BradescoTransparent", "./Caixa", "./CaixaTransparent", "./CartesBancaires", "./Cielo", "./CieloTransparent", "./Cirrus", "./Diners", "./DirectDebit", "./Discover", "./Dotpay", "./Ebay", "./Elavon", "./ElavonTransparent", "./Elo", "./Eway", "./Generic", "./GenericTransparent", "./Global", "./GlobalTransparent", "./Googlepay", "./Hiper", "./Hsbc", "./HsbcTransparent", "./Itau", "./ItauTransparent", "./Jcb", "./Klarna", "./Maestro", "./Mastercard", "./Pagseguro", "./PagseguroTransparent", "./Paypal", "./PaypalTransparent", "./Rede", "./RedeTransparent", "./Sage", "./Santander", "./SantanderTransparent", "./Sepa", "./Shopify", "./Skrill", "./SkrillMoneybookers", "./Solo", "./Stone", "./StoneTransparent", "./Swish", "./Trustly", "./UnionPay", "./Visa", "./VisaElectron", "./Wallet", "./WalletTransparent", "./Western", "./Worldpay", "./WorldpayTransparent"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("./Amazon"), require("./AmazonTransparent"), require("./Amex"), require("./Applepay"), require("./Aura"), require("./Bb"), require("./BbTransparent"), require("./Bitcoin"), require("./Boleto"), require("./BoletoTransparent"), require("./Bradesco"), require("./BradescoTransparent"), require("./Caixa"), require("./CaixaTransparent"), require("./CartesBancaires"), require("./Cielo"), require("./CieloTransparent"), require("./Cirrus"), require("./Diners"), require("./DirectDebit"), require("./Discover"), require("./Dotpay"), require("./Ebay"), require("./Elavon"), require("./ElavonTransparent"), require("./Elo"), require("./Eway"), require("./Generic"), require("./GenericTransparent"), require("./Global"), require("./GlobalTransparent"), require("./Googlepay"), require("./Hiper"), require("./Hsbc"), require("./HsbcTransparent"), require("./Itau"), require("./ItauTransparent"), require("./Jcb"), require("./Klarna"), require("./Maestro"), require("./Mastercard"), require("./Pagseguro"), require("./PagseguroTransparent"), require("./Paypal"), require("./PaypalTransparent"), require("./Rede"), require("./RedeTransparent"), require("./Sage"), require("./Santander"), require("./SantanderTransparent"), require("./Sepa"), require("./Shopify"), require("./Skrill"), require("./SkrillMoneybookers"), require("./Solo"), require("./Stone"), require("./StoneTransparent"), require("./Swish"), require("./Trustly"), require("./UnionPay"), require("./Visa"), require("./VisaElectron"), require("./Wallet"), require("./WalletTransparent"), require("./Western"), require("./Worldpay"), require("./WorldpayTransparent"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.Amazon, global.AmazonTransparent, global.Amex, global.Applepay, global.Aura, global.Bb, global.BbTransparent, global.Bitcoin, global.Boleto, global.BoletoTransparent, global.Bradesco, global.BradescoTransparent, global.Caixa, global.CaixaTransparent, global.CartesBancaires, global.Cielo, global.CieloTransparent, global.Cirrus, global.Diners, global.DirectDebit, global.Discover, global.Dotpay, global.Ebay, global.Elavon, global.ElavonTransparent, global.Elo, global.Eway, global.Generic, global.GenericTransparent, global.Global, global.GlobalTransparent, global.Googlepay, global.Hiper, global.Hsbc, global.HsbcTransparent, global.Itau, global.ItauTransparent, global.Jcb, global.Klarna, global.Maestro, global.Mastercard, global.Pagseguro, global.PagseguroTransparent, global.Paypal, global.PaypalTransparent, global.Rede, global.RedeTransparent, global.Sage, global.Santander, global.SantanderTransparent, global.Sepa, global.Shopify, global.Skrill, global.SkrillMoneybookers, global.Solo, global.Stone, global.StoneTransparent, global.Swish, global.Trustly, global.UnionPay, global.Visa, global.VisaElectron, global.Wallet, global.WalletTransparent, global.Western, global.Worldpay, global.WorldpayTransparent);
    global.index = mod.exports;
  }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_exports, _Amazon, _AmazonTransparent, _Amex, _Applepay, _Aura, _Bb, _BbTransparent, _Bitcoin, _Boleto, _BoletoTransparent, _Bradesco, _BradescoTransparent, _Caixa, _CaixaTransparent, _CartesBancaires, _Cielo, _CieloTransparent, _Cirrus, _Diners, _DirectDebit, _Discover, _Dotpay, _Ebay, _Elavon, _ElavonTransparent, _Elo, _Eway, _Generic, _GenericTransparent, _Global, _GlobalTransparent, _Googlepay, _Hiper, _Hsbc, _HsbcTransparent, _Itau, _ItauTransparent, _Jcb, _Klarna, _Maestro, _Mastercard, _Pagseguro, _PagseguroTransparent, _Paypal, _PaypalTransparent, _Rede, _RedeTransparent, _Sage, _Santander, _SantanderTransparent, _Sepa, _Shopify, _Skrill, _SkrillMoneybookers, _Solo, _Stone, _StoneTransparent, _Swish, _Trustly, _UnionPay, _Visa, _VisaElectron, _Wallet, _WalletTransparent, _Western, _Worldpay, _WorldpayTransparent) {
  "use strict";
