(function (global, factory) {
...
})(this, function (_exports, _react, _propTypes, _remoteImages) {
  "use strict";
  ...
  function (_React$Component) {
    ...
    function PaymentIcon(props) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(PaymentIcon).call(this, props));
      _this.state = {
        img: ""
      };
      return _this;
    ...
    _createClass(PaymentIcon, [{
      ...
      value: function componentDidMount() {
        ...
        Promise.resolve().then(function () {
          return _interopRequireWildcard(require("".concat(getPaymentImage(_this2.props.icon, _this2.props.transparent))));
        }).then(function (img) {
          _this2.setState({
            img: img
          });
      ...
      value: function render() {
        ...
        }, this.state.img ? _react["default"].createElement(this.state.img["default"], {
          style: this.props.style
        }) : ""));
      }
    }]);
